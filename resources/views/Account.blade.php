...
<body>
    <nav class="navbar navbar-light navbar-expand-md" id="nav_home" src="{{URL::asset('image/HealthLife_v2.png')}}">
        <div class="container-fluid"><img id="logo_img" src="{{URL::asset('image/HealthLife_v2.png')}}">
    ...
    <div id="content_div" class="content_div">
        ...
        <div class="main_content_div">
            <div id="account-version_div" class="div_parent_acc">
                <div class="col-6 column_acc" id="column_name_account"><img id="icon_acc" src="{{URL::asset('image/icon-account.png')}}" width="64" height="64">
                ...
                <div class="col column_acc" id="column_healthlife"><img src="{{URL::asset('image/organization_logo_url.png')}}">
            ...
            <div class="div_parent_sslt">
                <div>
                    <div class="col column_sslt" src="{{URL::asset('image/icon-setting.png')}}"><img class="img_sslt" src="{{URL::asset('image/icon-setting.png')}}" width="40" height="40">
                ...
                <div>
                    <div class="col column_sslt" src="{{URL::asset('image/icon-setting.png')}}"><img class="img_sslt" src="{{URL::asset('image/icon-help.png')}}" width="40" height="40">
                ...
                <div>
                    <div class="col column_sslt" src="assets/img/icon-setting.png"><img class="img_sslt" src="{{URL::asset('image/icon-logout.png')}}" width="40" height="40">
