        ...
        <div class="main_content_div">
            <div id="account-version_div" class="div_parent_acc">
                <div class="col-6 column_acc" id="column_name_account"><img id="icon_acc" src="{{URL::asset('img/icon-account.png')}}" width="64" height="64">
                    <div class="div_chi_acc-ver"><small class="form-text text-muted" id="text_name_account">{{$patientname}}</small><a id="text_editprofile" class="edit_profile" href="{{route('patient-profile', $accountid)}}">Edit profile</a></div>
                </div>
            ...
            <div class="div_parent_sslt">
                <div>
                    <div class="col column_sslt" src="assets/img/icon-setting.png"><img class="img_sslt" src="{{URL::asset('img/icon-setting.png')}}" width="40" height="40">
                        <div class="div_text_sslt"><a class="link_sslt" href="{{route('patient-setting', $accountid)}}">Settings</a><small class="form-text text-muted">Configure your account your way</small></div>
                    </div>
                </div>
                <div>
                    <div class="col column_sslt" src="assets/img/icon-setting.png"><img class="img_sslt" src="{{URL::asset('img/icon-help.png')}}" width="40" height="40">
                        <div class="div_text_sslt"><a class="link_sslt" href="{{route('patient-support', $accountid)}}">Support</a><small class="form-text text-muted">24/7 customer support</small></div>
                    </div>
                </div>
                <div>
