    ...
    <div id="content_div" class="content_div">
        ...
        <div class="main_content_div">
            <div>
                ...
                <form action="{{route('update-doctor-profile', $accountid)}}" method="POST">
                @csrf()
                            ...
                            <div>
                                ...
                                <div class="div_about">
                                    <div class="div_info_name div_name">
                                        <p class="text_about">Employee Name</p><input name="EmployeeName" class="form-control-sm input_about input_name_card" type="text" placeholder="Name" value="{{$employee->EmployeeName}}"></div>
                                    <div class="div_info_name div_name">
                                    ...
                                    <div class="div_info_name div_name">
                                        <p class="text_about">Date of Birth</p><input name="DayOfBirth" class="form-control-sm input_about input_name_card" type="text" placeholder="Year/Month/Year" value="{{$employee->DayOfBirth}}"></div>
                                    <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div class="div_info_name">
                                        <p class="text_contact">Degree</p><input name="Degree" class="form-control-sm input_contact" type="text" placeholder="Degree" value="{{$employee->Degree}}"></div>
                                    <div class="div_info_name">
                                        <p id="text_phone" class="text_contact">Speciality</p>
                                        <div><input name="Speciality" class="form-control-sm input_contact" type="text" placeholder="Speciality" value="{{$employee->Speciality}}"></div>
                                    </div>
                                    <div class="div_info_name">
                                        <p id="text_phone" class="text_contact">Medical School<br></p>
                                        <div><input name="MedicalSchool" class="form-control-sm input_contact" type="text" placeholder="Medical School" value="{{$employee->MedicalSchool}}"></div>
                                    </div>
                                    <div class="div_info_name">
                                        <p id="text_phone" class="text_contact">Year of Degree<br></p>
                                        <div><input name="YearOfDegree" class="form-control-sm input_contact" type="text" placeholder="Year of Degree" value="{{$employee->YearOfDegree}}"></div>
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div class="div_insurance_name">
                                        <p class="text_insurance">License Number</p><input id="id_licensenumber" name="LicenseNumber" class="form-control-sm input_insurance" type="text" placeholder="License Number" value="{{$employee->LicenseNumber}}"></div>
                                    <div class="div_info_name">
                                        <p class="text_about">License Contry</p><input id="id_licensecontry" name="LicenseCountry" class="form-control-sm input_insurance" type="text" placeholder="License Country" value="{{$employee->LicenseCountry}}"></div>
                                    <div class="div_info_name">
                                        <p class="text_about">License EXP</p><input id="id_licenseexp" name="LicenseExp" class="form-control-sm input_insurance" type="text" placeholder="Year/Month/Day" value="{{$employee->LicenseEXP}}"></div>
                                </div>   
                            </div>
                        </div>
                        @if($errors->any())
