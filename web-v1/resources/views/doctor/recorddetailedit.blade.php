        ...
        <div id="content_home"><small class="form-text text-muted name_table" id="text_name_table">Health Record Detail</small>
            <div id="table_last_result">
                ...
                <div class="col" id="column_detail">
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->HealthRecordID}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->HealthRecorDateTime}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->EmployeeID}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->Description}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->Diagnosis}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->Result}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->Notes}}"/><br>
                    <input type="text" class="text_edit_detail_record" style="border:none; width:100%; border-radius:20px; margin-bottom:2.7%; font-size:18px; background-color:#ffffff; padding-left:5%; text-align:center;" value="{{$healthrecordetail->TotalFee}}"/><br>
                </div>
            </div>
        </div>
    </div>
